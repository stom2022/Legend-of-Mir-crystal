            ...
            for (int i = 0; i < cell.Objects.Count; i++)
            {
                ...
                switch (spell)
                {
                    ...
                    case Spell.TwinDrakeBlade:
                        ...
                        damageFinal = magic.GetDamage(damageBase);
                        // Do not automatically disable TwinDrakeBlade here; it is now a toggle skill
        ...
        public void SpellToggle(Spell spell, SpellToggleState state)
        {
            ...
            switch (spell)
            {
                ...
                case Spell.DoubleSlash:
                    ...
                    break;
                case Spell.TwinDrakeBlade:
                    // Toggle TwinDrakeBlade like DoubleSlash. Do not immediately deduct MP or enqueue an ObjectMagic here.
                    Info.TwinDrakeBlade = state == SpellToggleState.None ? !Info.TwinDrakeBlade : use;
                    // update runtime flag as well
                    TwinDrakeBlade = Info.TwinDrakeBlade;
                    Enqueue(new S.SpellToggle { ObjectID = ObjectID, Spell = Spell.TwinDrakeBlade, CanUse = Info.TwinDrakeBlade });
                    break;
                case Spell.FlamingSword:
